...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    _listWithMapAndOtherModelValues = [aDecoder decodeObjectOfClasses:[NSSet setWithArray:@[[User class], [NSDictionary class], [NSArray class]]] forKey:@"list_with_map_and_other_model_values"];
    ...
    _mapPolymorphicValues = [aDecoder decodeObjectOfClasses:[NSSet setWithArray:@[[User class], [NSDictionary class], [Board class], [Image class], [Everything class], [Pin class], [NSArray class]]] forKey:@"map_polymorphic_values"];
    ...
    _polymorphicProp = [aDecoder decodeObjectOfClasses:[NSSet setWithArray:@[[User class], [NSURL class], [Image class], [Board class], [Pin class], [Everything class], [NSString class], [NSNumber class], [NSDate class]]] forKey:@"polymorphic_prop"];
    ...
    _setPropWithPrimitiveValues = [aDecoder decodeObjectOfClasses:[NSSet setWithArray:@[[NSSet class], [NSNumber class]]] forKey:@"set_prop_with_primitive_values"];
